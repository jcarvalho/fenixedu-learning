...
@SpringApplication(group = "logged", path = "news", title = "cms.news")
@SpringFunctionality(accessGroup = "logged", app = NewsController.class, title = "cms.news")
...
public class NewsController {
    ...
    public String showPost(Model model, @PathVariable String siteSlug, @PathVariable String postSlug) {
        ...
        return "fenixedu-learning/news-post";
    }
